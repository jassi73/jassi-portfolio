...
const backendNodes: SkillNode[] = [
  ...
  {
    name: 'Python & FastAPI',
    fullName: 'Python & FastAPI Backend',
    description: 'High-performance Python REST APIs built with FastAPI, Pydantic data validation, async routing, and seamless backend collaboration across e-commerce product listings and checkout services.',
    color: '#1A333E',
    textColor: '#99E6E2',
    bgOutlineColor: 'rgba(124, 92, 255, 0.3)',
    size: 85,
...
const aiNodes: SkillNode[] = [
  ...
  {
    name: 'AI & AGI',
    fullName: 'AI, LLM & AGI with Python',
    description: 'Currently learning Artificial Intelligence, Large Language Models (LLMs), AGI concepts, and Python AI frameworks.',
    color: '#3B1E42',
    textColor: '#E9D5FF',
    bgOutlineColor: 'rgba(124, 92, 255, 0.3)',
    size: 80,
